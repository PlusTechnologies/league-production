...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <p>Note: the privacy practices set forth in this privacy policy are for this web site only. If you visit other web sites, please review the privacy policies posted at those sites.</p>
      ...
      <ul>
        <li>1.    permitted or required by law; or,</li>
        <li>2.    trying to protect against or prevent actual or potential fraud or unauthorized transactions; or,</li>
        <li>3.    investigating fraud which has already taken place. The information is not provided to these companies for marketing purposes.</li>
      </ul>
      ...
      <p>If you have any questions, concerns, or comments about our privacy policy you may contact us using the information below:
        <br>By email: privacy@leaguetogether.com
        <br>We reserve the right to make changes to this policy. Any changes to this policy will be posted.
      </p>
      <hr>
      <h1>Refunds</h1>
      <p>I understand that due to the nature and expense of pre-planned events, tournaments, camps, clinics, workshops, and select teams, League Together has a policy of no refunds.</p>
