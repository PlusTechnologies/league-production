		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="col-md-7 same-height col-md-offset-1">
					<h3>Edit Contact</h3>
					<p></p>
					{{Form::open(array('action' => array('ClubController@contactUpdate', $player->id, $contact->id), 'class'=>'form-horizontal', 'method' => 'post')) }}
					@if($errors->has())
					<div class="row">
						<div class="col-sm-12">
						...
						<div class="col-xs-12">
							...
							<div class="form-group">
								<div class="col-sm-12 text-right">
									...
									<a href="{{URL::action('ClubController@contactDelete', array($player->id, $contact->id))}}" class="btn btn-danger btn-outline">Delete</a>
									<a href="{{URL::action('ClubController@playerEdit', $player->id)}}" class="btn btn-default">Cancel</a>
								</div>
							</div>
						</div>
					</div>
