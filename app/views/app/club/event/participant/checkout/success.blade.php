    ...
    <div class="col-md-6 col-md-offset-3 receipt-bg">
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          <p class="text-muted">
            <small class="pull-left" >{{ date("M d, Y",strtotime($result->date->date))}} at {{ date("h:i:s A",strtotime($result->date->date))}}</small>
            <small class="pull-right">Receipt # {{$result->transactionid}}</small>
          </p>
        </div>
