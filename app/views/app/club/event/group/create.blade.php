		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="col-md-7 same-height col-md-offset-1">
					...
					<p></p>
					{{Form::open(array('action' => array('GroupController@store', $event->id), 'class'=>'form-horizontal', 'method' => 'post')) }}
					@if($errors->has())
					<div class="row">
						<div class="col-sm-12">
						...
						<div class="col-xs-12">
							...
							<div class="form-group">
								<div class="col-sm-12 text-right">
									...
									<button type="submit" class="btn btn-primary btn-outline">Create Group</button>
								</div>
							</div>
						</div>
					</div>
