		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="col-md-7 same-height col-md-offset-1">
					<h3>Edit Event</h3>
					<p></p>
					{{Form::open(array('action' => array('EventoController@update', $event->id), 'class'=>'form-horizontal', 'method' => 'PUT')) }}
					@if($errors->has())
					<div class="row">
						<div class="col-sm-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::select('type', $types, $event->type_id, array('class' => 'form-control') ) }}
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">Address</label>
								<div class="col-sm-9">
									{{ Form::text('location',$event->location, array('id'=>'searchGoogleApi','class' => 'form-control')) }}
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::text('date',$event->date, array('class' => 'form-control datepicker')) }}
								</div>
							</div>
							<div class="form-group">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::text('fee',$event->fee, array('class' => 'dollar')) }}
								</div>
							</div>
							<div class="form-group">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									{{ Form::textarea('notes',$event->notes,array('size' => '30x5', 'class' => 'form-control')) }}
