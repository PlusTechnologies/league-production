    ...
    <div class="col-md-10 col-md-offset-1">
      <div class="row">
        <div class="col-sm-6">
          ...
          {{ Form::open(array('action' => array('MemberController@doDecline', $member->id),"class"=>"form-horizontal",'id'=>'members','method' => 'post')) }}
          <p class="text-right">
            <button class="btn btn-danger btn-outline" type="submit">Decline Team</button>
