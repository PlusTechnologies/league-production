                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      <div class="col-sm-12 text-right">
                        <button class="btn btn-primary btn-block" type="submit" id="add-team">Update</button>
                        <a href="{{ URL::action('TeamController@show', $team->id) }}" class="btn btn-default btn-block" >Cancel</a>
                      </div>
                    </div>
                  </div>
                </div>
