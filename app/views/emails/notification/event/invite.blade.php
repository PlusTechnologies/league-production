...
<head>
 ...
 <title>LeagueTogether Notification</title>
 <style type="text/css">
                    ...
                    <tbody>
                     <tr>
                      <td valign="top" class="mcnTextContent" style="padding: 9px 18px;color: #F4F5F0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: Helvetica;font-size: 11px;line-height: 125%;text-align: left;">
                       <h1 class="null" style="color: #F4F5F0 !important;text-align: center;margin: 0;padding: 0;display: block;font-family: Helvetica;font-size: 40px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: -1px;">Notification</h1>
                      </td>
                     </tr>
                    </tbody>
                   </table>
                      ...
                      <td valign="top" class="mcnTextContent" style="padding: 5px 50px 5px 50px;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size: 12px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;line-height: 150%;">
                       ...
                       <table align="left" border="0" cellpadding="0" cellspacing="0" width="232" class="mcnTextContentContainer" style="text-align:left;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <tbody>
                         <tr>
                          <td valign="top" class="mcnTextContent" style="padding: 5px 0 5px 18px;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size: 11px;text-align:left;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;line-height: 150%;">
                           You're invited to join our event <b>{{$participant->event->name}}</b>, please click the link below to accept or decline this invitation.<br><br> 
                           This invitation is exclusive for your player <b> {{$player->firstname}} {{$player->lastname}}</b><br><br> 

                           <a href="{{URL::action('PlayerController@index')}}">Click here to accept or decline</a><br> 
                           <small>*Look for the invites section on this page to complete the process.</small>
                          </td>
                         </tr>
                        </tbody>
                       </table>
                    ...
                    <tbody>
                     <tr>
                      <td valign="top" class="mcnTextContent" style="padding: 9px 0px 9px 18px;color: #CACACA;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size: 11px;text-align: right;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;line-height: 150%;">
                       <img align="none" height="18" src="http://gallery.mailchimp.com/17f9a4283a5c17dc2cf4966de/images/2d757c21-01da-472a-a613-518037274bf3.png" style="width: 26px;height: 18px;margin: 0px;border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" width="26">
                       <br><br>
                      </td>
                     </tr>
                    </tbody>
